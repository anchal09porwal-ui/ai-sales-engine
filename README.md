...
```bash
curl -fsSL https://raw.githubusercontent.com/anchal09porwal-ui/ai-sales-engine/main/install.sh | bash
```

### Manual Install

```bash
git clone https://github.com/anchal09porwal-ui/ai-sales-engine.git
...
# Or remotely
curl -fsSL https://raw.githubusercontent.com/anchal09porwal-ui/ai-sales-engine/main/uninstall.sh | bash
```
